...
ARQUIVO_SAIDA = "Todososprodutossemanal-AS.csv"

# BUCKET NAME DELTA TABLES
BUCKET_NAME = 'XXXXXXXXXXXXXXXXXXXXXXX0336967'
KEY_RAW = f'raw-zone/crawlers/scanntech/semanal/as/year={hoje:%Y}/month={hoje:%m}/day={hoje:%d}/{ARQUIVO_SAIDA}'

EMAIL = 'XXXXXXXXXXXXXXXXXXXXX'
PW = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX3'

office_login = 'https://ssso.XXXXXXXXXXXXXXXXXXXXXXXXXXXXXb-b76b4c38fc5e'
forms_resposta = 'https://analytics.scXXXXXXXXXXXXXXXXoard'
forms_dash = 'https://tableau4.scXXXXXXXXXXmentoMarca/e8593Xn&XizHome=n'
...
authcookie = Office365('https://XXXXXXXXXXXXXXXXXXXXXXX.sharepoint.com/', 
                       username='XXXXXXXXXXXXXXXXXXXXXXXXX.br', 
                       password='XXXXXXXXXXXXXXXXXXXXXXXXXXXX1@').GetCookies()

site = Site('https://XXXXXXXXXXXXX.sharepoint.com/sites/XXXXXXXXXXXXXXXXXX/', 
