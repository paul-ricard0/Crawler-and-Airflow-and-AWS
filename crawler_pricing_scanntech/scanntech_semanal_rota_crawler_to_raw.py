...
ARQUIVO_SAIDA = "Todososprodutossemanal-ROTA.csv"

# BUCKET NAME DELTA TABLES
BUCKET_NAME = 'CCCCCCCCCCCCCCCCCCCC080336967'
KEY_RAW = f'raw-zone/crawlers/scanntech/semanal/rota/year={hoje:%Y}/month={hoje:%m}/day={hoje:%d}/{ARQUIVO_SAIDA}'

EMAIL = 'CCCCCCCCCCCCCCC@XXXXXXXXXXXXXXX.com.br'
PW = 'XXXXXXXXXXXXXXXX@XXXXXXXXXXXXXXXX'


office_login = 'https:/XclienX877-8d6b-b76b4c38fc5e'
forms_resposta = 'https:Xdashboard'
forms_dash = 'https://tablXricing-MeXrca/fcX&:display_count=n&:showVizHome=n&:origin=viz_share_link'
...
authcookie = Office365('https://X.sharepoint.com/', 
                       username='X.X@X.X.X', 
                       password='#XXXXXX@').GetCookies()

site = Site('https://X.sharepoint.com/sites/X/', 
