...
BUCKET_NAME = 'XXXXXXXXXXXXXXXXX36967'
...
if __name__ == '__main__':
    ...
    indicadores = ['atacado', 'boi-gordo']

    for indicador in indicadores:
        # BUCKET NAME DELTA TABLES
        print('\n\n'+ indicador.upper())
        path_staging = f'staging-zone/crawlers/pricing/scot/{indicador}/fat/year={date_today:%Y}/month={date_today:%m}/day={date_today:%d}/'
        
        key_manifest = f'consumer-zone/crawlers/pricing/scot/{indicador}/fat/_symlink_format_manifest/manifest'
        
        path_parquet = f'consumer-zone/crawlers/pricing/scot/{indicador}/fat/year={date_today:%Y}/month={date_today:%m}/day={date_today:%d}/scot_{indicador}_{date_today}.parquet'
